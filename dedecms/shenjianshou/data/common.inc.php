...
if($cfg_ask == 'N')
{
    ta_fail(TA_ERROR_PLUGIN_ERROR, 'ask close', $dede_charset['msg']['fail_question_close']);
}
//会员信息
...
if($cfg_ask_isdomain == 'Y')
{
    ...
    {
        ta_fail(TA_ERROR_PLUGIN_ERROR, $cfg_ask_domain, $dede_charset['msg']['illegal_operation']);
    }
}
?>